...
import org.order.executor.task.entry.EntryTaskRunner;
...
@Slf4j
@Component
public class EntryTaskExecutor {
    ...
    @Autowired
    private EntryTaskRunner taskRunner;

    public void submitTask(EntryTaskUnit taskUnit) {
        executor.submit(() -> {
